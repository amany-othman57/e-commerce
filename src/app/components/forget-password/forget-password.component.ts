...
export class ForgetPasswordComponent implements OnDestroy {
  ...
  statusMsg:string=''
  userEmail:string=''
  unSubForget :Subscription={} as Subscription;
    unSubResetCode:Subscription={} as Subscription;
  unSubResetPass:Subscription={} as Subscription;
...
this.unSubForget=  this._ResetPasswordService.forgetPassword(this.emailForm.value).subscribe({
    next:(res)=>{
      console.log(res)
...
this.unSubResetCode=    this._ResetPasswordService.resetCode(this.resetCodeForm.value).subscribe({
    next:(res)=>{
      console.log(res)
...
if(this.newPasswordForm.valid){
 this.unSubResetPass= this._ResetPasswordService.resetPassword(this.newPasswordForm.value).subscribe({
  next:(res)=>{
    console.log(res)
